...
import { Receipt, Calendar, Zap, CreditCard, CheckCircle2, Clock, XCircle, FileText, User as UserIcon } from "lucide-react";
...
const AdminInvoicesPage = () => {
  ...
  if (isError) {
    return (
      <main className="mt-4 px-4 sm:px-6 lg:px-8">
        <div className="mb-6 sm:mb-8">
          <h1 className="text-3xl sm:text-4xl font-bold text-foreground mb-2">All Invoices</h1>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-3xl sm:text-4xl font-bold text-foreground">All Invoices</h1>
            </div>
            <p className="text-gray-600 text-sm sm:text-base ml-11">
              View and manage invoices for all users
            </p>
          </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div className="space-y-2 flex-1">
                      ...
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-gray-600">
                          User: <span className="font-semibold text-gray-900">
                            ...
                            {invoice.userId.email && ` (${invoice.userId.email})`}
                          </span>
                        </span>
                      </div>
                    )}
                    ...
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      <span className="text-gray-600">
                        Amount: <span className="font-semibold text-gray-900">${(invoice.totalEnergyGenerated * 0.05).toFixed(2)}</span>
                      </span>
                    </div>
                  </div>
                </div>
          ...
          <Card className="border-dashed">
            <CardContent className="py-12 sm:py-16 text-center">
              ...
              <p className="text-sm text-gray-600 max-w-sm mx-auto">
                {statusFilter !== "all" || userIdFilter !== "all"
