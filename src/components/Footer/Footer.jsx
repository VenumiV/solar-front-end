...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-br from-gray-100 to-gray-200 border-t border-gray-300">
      <div className="px-4 sm:px-6 lg:px-12 xl:px-20 pt-12 sm:pt-16 pb-8">
          ...
          <div className="flex items-center gap-3">
            {[
              ...
              <a
                key={item.name}
                href="#"
                className="flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-full bg-white text-gray-600 shadow-md transition-all duration-300 hover:bg-blue-500 hover:text-white hover:scale-110 hover:shadow-lg"
      ...
      {/* Bottom Bar */}
      <div className="border-t border-gray-300 bg-gray-200/50">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-12 xl:px-20 py-6 sm:py-8">
          <div className="flex flex-col gap-4 sm:gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex flex-wrap gap-3 sm:gap-4 text-xs sm:text-sm text-gray-600">
              <a className="whitespace-nowrap transition-colors hover:text-blue-600 font-medium" href="/">Privacy Policy</a>
              <a className="whitespace-nowrap transition-colors hover:text-blue-600 font-medium" href="/">Terms of Service</a>
              <a className="whitespace-nowrap transition-colors hover:text-blue-600 font-medium" href="/">Cookie Policy</a>
              <a className="whitespace-nowrap transition-colors hover:text-blue-600 font-medium" href="/">Accessibility</a>
            </div>
